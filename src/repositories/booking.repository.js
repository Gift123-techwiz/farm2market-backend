...
class BookingRepository {
    ...
    async findAll(filters = {}) {
        const query = this.repository
            ...
            .leftJoinAndSelect("booking.farmer", "farmer");

        if (filters.farmer_id) {
            query.andWhere("booking.farmer_id = :farmer_id", {
                farmer_id: filters.farmer_id,
            });
        }

        if (filters.cold_room_id) {
            query.andWhere("booking.cold_room_id = :cold_room_id", {
                cold_room_id: filters.cold_room_id,
            });
        }
